...
myApp.controller('SamenstellenController', function ($scope, DOODService, $routeParams, $location) {
    ...
    var totaleTijd,
        ...
        verwijderSegmentUitDb = function (data, callback) {
            $scope.segmenten = DOODService.uitvaartSegment.delete({gebruiker: data.gebruikersnaam, gebruikersnaam: data.gebruikersnaam, object: data.object, percentage: data.percentage, volgnr: data.volgnummer, volgnummer: data.volgnummer}, function () {
        ...
        getDataTableUitDb = function getDataTableUitDb(callback) {
            ...
            gebruiker = DOODService.gebruikerSessie.get(function () {
                if (gebruiker.doc.gebruikersnaam !== undefined) {
                    var segmenten = DOODService.uitvaartSegment.get({gebruiker: gebruiker.doc.gebruikersnaam}, function () {
